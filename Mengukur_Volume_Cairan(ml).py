...
def detect_video(weights, source, output, conf=0.25, device="CPU"):
    ...
    BERAT_ISI_GRAM     = 46.0 #input dari sensor   
    ...
    # ==========================================
    REF_PIXEL_HEIGHT   = 900.0  # Tinggi piksel saat full
    ...
    while True:
        ...
        if results[0].boxes is not None:
            ...
            for box in boxes:
                ...
                warnanya = (0, 255, 0) if error_persen < 5.0 else (0, 0, 255)
